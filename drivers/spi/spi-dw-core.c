...
/* Configure CTRLR0 for DWC_apb_ssi v4 (32 bits CTRLR0) */
u32 dw_spi_update_cr0_32(struct spi_controller *master,
			 struct spi_device *spi, struct spi_transfer *transfer)
{
	...
	cr0 |= FIELD_PREP(DWC_APB_CTRLR0_32_DFS_MASK,
			  transfer->bits_per_word - 1);

	return cr0;
}
EXPORT_SYMBOL_GPL(dw_spi_update_cr0_apb_v4);
