...
/**
 * The Kendryte K210 Field Programmable GPIO Array (FPIOA)
 ...
 */
#define K210_FPIOA_IO_NUM	48
#define K210_FPIOA_FUNC_NUM	256
#define K210_FPIOA_TIE_NUM	(K210_FPIOA_FUNC_NUM / 32)
