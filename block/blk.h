...
enum bio_merge_status blk_attempt_bio_merge(struct request_queue *q,
				...
				unsigned int nr_segs, bool sched_allow_merge);
...
static inline bool bio_zone_is_seq(struct bio *bio)
{
	return false;
}
static inline bool bio_zone_write_plugging(struct bio *bio)
...
static inline void blk_zone_write_plug_bio_split(struct bio *bio,
						 struct bio *split)
{
}
