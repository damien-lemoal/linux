...
static inline ssize_t pci_epf_map_size(struct pci_epf *epf, u64 pci_addr,
				       size_t pci_size, size_t *phys_size,
				       phys_addr_t *phys_ofst)
{
	return pci_epc_map_size(epf->epc, epf->func_no, epf->vfunc_no,
...
static inline int pci_epf_mem_map(struct pci_epf *epf, u64 pci_addr,
				  size_t pci_size, struct pci_epc_map *map)
{
